...
header("Location: http://127.0.0.1/Faceio/student-result-management/adminfaceio.php");
...
<html lang="en">
    ...
    <body class="top-navbar-fixed" style="background-image:url('images/back4.jpg');background-size:cover;background-position:center;">
