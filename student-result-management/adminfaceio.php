...
<button onclick="enrollNewUser()" title="Enroll a new user on this FACEIO application">Enroll New Student</button>
...
<script type="text/javascript">
	...
	function enrollNewUser() {
        ...
        window.location.replace("http://127.0.0.1/Faceio/student-result-management/add-students.php");
		}).catch(errCode => {
